...
{
    private const string ACCOUNT_EMAIL = "duma.aporillo.coc@phinmaed.com";
    private const string ACCOUNT_PASSWORD = "wgasewuepnxmhyxd";
    ...
    private static string SUBJECT_LABEL = "Inventory Inquiry"; //private static string SUBJECT_LABEL = "[MyAppName]";
