...
public partial class UserAccount
{
    ...
    private static InventoryDbContext _db = new InventoryDbContext();
    ...
    // Method to authenticate the user based on username only
    ...
    public static Guid? Create(string userName, string userPassword, string email, string userRoles = "", bool requiresActivation = false)
    {
    ...
    public static bool ChangePasswordForgot(string userName, string newPassword = "", bool forceChange = false)
    {
        if (string.IsNullOrWhiteSpace(newPassword))
            return false;
